...
2. "Подбор задания". Задания подбираются культисту на основе его звания, ранга, других взятых им заданий и по другим критериям. Культист выбирает задание из списка и подтверждает его. После этого статус задания с "Доступный" меняется на "Выполняется" (после этого остальные культисты не могут его взять) ✅
